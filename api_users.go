...
func (a *UsersApiService) CreateUser(ctx context.Context, body CreateUserRequest, xRequestId string, localVarOptionals *UsersApiCreateUserOpts) (CreateUserResponse, *http.Response, error) {
	var (
...
/*
UsersApiService Delete existing user by id
...
func (a *UsersApiService) DeleteUser(ctx context.Context, xRequestId string, userId string, localVarOptionals *UsersApiDeleteUserOpts) (*http.Response, error) {
	var (
...
/*
UsersApiService Generate new client secret
Generate and get new client secret.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *UsersApiGenerateClientSecretOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return GenerateClientSecretResponse
*/

type UsersApiGenerateClientSecretOpts struct {
    XTraceId optional.String
}

func (a *UsersApiService) GenerateClientSecret(ctx context.Context, xRequestId string, localVarOptionals *UsersApiGenerateClientSecretOpts) (GenerateClientSecretResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/users/client/secret"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v GenerateClientSecretResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
UsersApiService Resend email verification
Resend email verification for a specific user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param userId The identifier of the user
 * @param optional nil or *UsersApiResendEmailVerificationOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     * @param "RedirectUrl" (optional.String) -  The redirect url used for email verification

*/

type UsersApiResendEmailVerificationOpts struct {
    XTraceId optional.String
    RedirectUrl optional.String
}

func (a *UsersApiService) ResendEmailVerification(ctx context.Context, xRequestId string, userId string, localVarOptionals *UsersApiResendEmailVerificationOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/users/{userId}/resend-email-verification"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", fmt.Sprintf("%v", userId), -1)
...
/*
UsersApiService Send reset password email
Send reset password email for a specific user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param userId The identifier of the user
 * @param optional nil or *UsersApiResetPasswordOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     * @param "RedirectUrl" (optional.String) -  The redirect url used for resetting password

*/

type UsersApiResetPasswordOpts struct {
    XTraceId optional.String
    RedirectUrl optional.String
}

func (a *UsersApiService) ResetPassword(ctx context.Context, xRequestId string, userId string, localVarOptionals *UsersApiResetPasswordOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/users/{userId}/reset-password"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", fmt.Sprintf("%v", userId), -1)
...
/*
UsersApiService Get specific user by id
Get attributes for a specific user.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param userId The identifier of the user
 * @param optional nil or *UsersApiRetrieveUserOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return FindUserResponse
*/

type UsersApiRetrieveUserOpts struct {
    XTraceId optional.String
}

func (a *UsersApiService) RetrieveUser(ctx context.Context, xRequestId string, userId string, localVarOptionals *UsersApiRetrieveUserOpts) (FindUserResponse, *http.Response, error) {
	var (
...
/*
UsersApiService Get client
Get idm client.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *UsersApiRetrieveUserClientOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return FindClientResponse
*/

type UsersApiRetrieveUserClientOpts struct {
    XTraceId optional.String
}

func (a *UsersApiService) RetrieveUserClient(ctx context.Context, xRequestId string, localVarOptionals *UsersApiRetrieveUserClientOpts) (FindClientResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/users/client"
...
/*
UsersApiService Get user is password set status
Get info about idm user if the password is set.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *UsersApiRetrieveUserIsPasswordSetOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return FindUserIsPasswordSetResponse
*/

type UsersApiRetrieveUserIsPasswordSetOpts struct {
    XTraceId optional.String
}

func (a *UsersApiService) RetrieveUserIsPasswordSet(ctx context.Context, xRequestId string, localVarOptionals *UsersApiRetrieveUserIsPasswordSetOpts) (FindUserIsPasswordSetResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/users/is-password-set"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FindUserIsPasswordSetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *UsersApiRetrieveUserListOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     ...
     * @param "Email" (optional.String) -  Filter as substring match for user emails.
     * @param "Enabled" (optional.Bool) -  Filter if user is enabled or not.
@return ListUserResponse
*/

type UsersApiRetrieveUserListOpts struct {
    XTraceId optional.String
    Page optional.Int64
    Size optional.Int64
...
func (a *UsersApiService) RetrieveUserList(ctx context.Context, xRequestId string, localVarOptionals *UsersApiRetrieveUserListOpts) (ListUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
UsersApiService Update specific user by id
...
func (a *UsersApiService) UpdateUser(ctx context.Context, body UpdateUserRequest, xRequestId string, userId string, localVarOptionals *UsersApiUpdateUserOpts) (UpdateUserResponse, *http.Response, error) {
	var (
