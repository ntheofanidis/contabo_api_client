...
/*
TagAssignmentsApiService Create a new assignment for the tag
 ...
 * @param resourceType The identifier of the resource type. Resource type is one of &#x60;instance|image&#x60;.
 * @param resourceId The identifier of the resource id
 * @param optional nil or *TagAssignmentsApiCreateAssignmentOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return CreateAssignmentResponse
*/

type TagAssignmentsApiCreateAssignmentOpts struct {
    XTraceId optional.String
}

func (a *TagAssignmentsApiService) CreateAssignment(ctx context.Context, xRequestId string, tagId int64, resourceType string, resourceId string, localVarOptionals *TagAssignmentsApiCreateAssignmentOpts) (CreateAssignmentResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/tags/{tagId}/assignments/{resourceType}/{resourceId}"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 201 {
			var v CreateAssignmentResponse
...
/*
TagAssignmentsApiService Delete existing tag assignment
 ...
 * @param resourceType The identifier of the resource type. Resource type is one of &#x60;instance|image&#x60;.
 * @param resourceId The identifier of the resource id
 * @param optional nil or *TagAssignmentsApiDeleteAssignmentOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.

*/

type TagAssignmentsApiDeleteAssignmentOpts struct {
    XTraceId optional.String
}

func (a *TagAssignmentsApiService) DeleteAssignment(ctx context.Context, xRequestId string, tagId int64, resourceType string, resourceId string, localVarOptionals *TagAssignmentsApiDeleteAssignmentOpts) (*http.Response, error) {
	var (
...
/*
TagAssignmentsApiService Get specific assignment for the tag
 ...
 * @param resourceType The identifier of the resource type. Resource type is one of &#x60;instance|image&#x60;.
 * @param resourceId The identifier of the resource id
 * @param optional nil or *TagAssignmentsApiRetrieveAssignmentOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return FindAssignmentResponse
*/

type TagAssignmentsApiRetrieveAssignmentOpts struct {
    XTraceId optional.String
}

func (a *TagAssignmentsApiService) RetrieveAssignment(ctx context.Context, xRequestId string, tagId int64, resourceType string, resourceId string, localVarOptionals *TagAssignmentsApiRetrieveAssignmentOpts) (FindAssignmentResponse, *http.Response, error) {
	var (
...
/*
TagAssignmentsApiService List tag assignments
List and filter all existing assignments for a tag in your account
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param tagId The identifier of the tag.
 * @param optional nil or *TagAssignmentsApiRetrieveAssignmentListOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     ...
     * @param "ResourceType" (optional.String) -  Filter as substring match for assignment resource type. Resource type is one of &#x60;instance|image&#x60;.
@return ListAssignmentResponse
*/

type TagAssignmentsApiRetrieveAssignmentListOpts struct {
    XTraceId optional.String
    Page optional.Int64
    Size optional.Int64
...
func (a *TagAssignmentsApiService) RetrieveAssignmentList(ctx context.Context, xRequestId string, tagId int64, localVarOptionals *TagAssignmentsApiRetrieveAssignmentListOpts) (ListAssignmentResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/tags/{tagId}/assignments"
	localVarPath = strings.Replace(localVarPath, "{"+"tagId"+"}", fmt.Sprintf("%v", tagId), -1)
