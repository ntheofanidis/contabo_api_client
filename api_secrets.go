...
/*
SecretsApiService Create a new secret
 ...
 * @param optional nil or *SecretsApiCreateSecretOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return CreateSecretResponse
*/

type SecretsApiCreateSecretOpts struct {
    XTraceId optional.String
}

func (a *SecretsApiService) CreateSecret(ctx context.Context, body CreateSecretRequest, xRequestId string, localVarOptionals *SecretsApiCreateSecretOpts) (CreateSecretResponse, *http.Response, error) {
	var (
...
/*
SecretsApiService Delete existing secret by id
...
func (a *SecretsApiService) DeleteSecret(ctx context.Context, xRequestId string, secretId int64, localVarOptionals *SecretsApiDeleteSecretOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/secrets/{secretId}"
...
/*
SecretsApiService Get specific secret by id
Get attributes values for a specific secret on your account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param secretId The id of the secret
 * @param optional nil or *SecretsApiRetrieveSecretOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return FindSecretResponse
*/

type SecretsApiRetrieveSecretOpts struct {
    XTraceId optional.String
}

func (a *SecretsApiService) RetrieveSecret(ctx context.Context, xRequestId string, secretId int64, localVarOptionals *SecretsApiRetrieveSecretOpts) (FindSecretResponse, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *SecretsApiRetrieveSecretListOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     ...
     * @param "Name" (optional.String) -  Filter secrets by name
     * @param "Type_" (optional.String) -  Filter secrets by type
@return ListSecretResponse
*/

type SecretsApiRetrieveSecretListOpts struct {
    XTraceId optional.String
    Page optional.Int64
    Size optional.Int64
...
func (a *SecretsApiService) RetrieveSecretList(ctx context.Context, xRequestId string, localVarOptionals *SecretsApiRetrieveSecretListOpts) (ListSecretResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SecretsApiService Update specific secret by id
 ...
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param secretId The id of the secret
 * @param optional nil or *SecretsApiUpdateSecretOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return UpdateSecretResponse
*/

type SecretsApiUpdateSecretOpts struct {
    XTraceId optional.String
}

func (a *SecretsApiService) UpdateSecret(ctx context.Context, body UpdateSecretRequest, xRequestId string, secretId int64, localVarOptionals *SecretsApiUpdateSecretOpts) (UpdateSecretResponse, *http.Response, error) {
	var (
