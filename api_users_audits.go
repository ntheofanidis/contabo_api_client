...
/*
UsersAuditsApiService List history about your users (audit)
 ...
 * @param optional nil or *UsersAuditsApiRetrieveUserAuditsListOpts - Optional Parameters:
     ...
     * @param "UserId" (optional.String) -  The identifier of the user.
...
type UsersAuditsApiRetrieveUserAuditsListOpts struct {
...
func (a *UsersAuditsApiService) RetrieveUserAuditsList(ctx context.Context, xRequestId string, localVarOptionals *UsersAuditsApiRetrieveUserAuditsListOpts) (ListUserAuditResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/users/audits"
