...
/*
InstancesAuditsApiService List history about your instances (audit) triggered via the API
 ...
 * @param optional nil or *InstancesAuditsApiRetrieveInstancesAuditsListOpts - Optional Parameters:
     ...
     * @param "InstanceId" (optional.Int64) -  The identifier of the instances.
...
type InstancesAuditsApiRetrieveInstancesAuditsListOpts struct {
...
func (a *InstancesAuditsApiService) RetrieveInstancesAuditsList(ctx context.Context, xRequestId string, localVarOptionals *InstancesAuditsApiRetrieveInstancesAuditsListOpts) (ListInstancesAuditResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/compute/instances/audits"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListInstancesAuditResponse
