...
/*
RolesAuditsApiService List history about your roles (audit)
 ...
 * @param optional nil or *RolesAuditsApiRetrieveRoleAuditsListOpts - Optional Parameters:
     ...
     * @param "RoleId" (optional.Int64) -  The identifier of the role.
...
type RolesAuditsApiRetrieveRoleAuditsListOpts struct {
...
func (a *RolesAuditsApiService) RetrieveRoleAuditsList(ctx context.Context, xRequestId string, localVarOptionals *RolesAuditsApiRetrieveRoleAuditsListOpts) (ListRoleAuditResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/roles/audits"
