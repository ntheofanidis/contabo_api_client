...
/*
SnapshotsApiService Create a new instance snapshot
...
func (a *SnapshotsApiService) CreateSnapshot(ctx context.Context, body CreateSnapshotRequest, xRequestId string, instanceId int64, localVarOptionals *SnapshotsApiCreateSnapshotOpts) (CreateSnapshotResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/compute/instances/{instanceId}/snapshots"
...
/*
SnapshotsApiService Delete existing snapshot by id
...
func (a *SnapshotsApiService) DeleteSnapshot(ctx context.Context, xRequestId string, instanceId int64, snapshotId string, localVarOptionals *SnapshotsApiDeleteSnapshotOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/compute/instances/{instanceId}/snapshots/{snapshotId}"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", fmt.Sprintf("%v", instanceId), -1)
...
/*
SnapshotsApiService Retrieve a specific snapshot by id
Get all attributes for a specific snapshot
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param instanceId The identifier of the instance
 * @param snapshotId The identifier of the snapshot
 * @param optional nil or *SnapshotsApiRetrieveSnapshotOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return FindSnapshotResponse
*/

type SnapshotsApiRetrieveSnapshotOpts struct {
    XTraceId optional.String
}

func (a *SnapshotsApiService) RetrieveSnapshot(ctx context.Context, xRequestId string, instanceId int64, snapshotId string, localVarOptionals *SnapshotsApiRetrieveSnapshotOpts) (FindSnapshotResponse, *http.Response, error) {
	var (
 ...
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param instanceId The identifier of the instance
 * @param optional nil or *SnapshotsApiRetrieveSnapshotListOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     ...
     * @param "Name" (optional.String) -  Filter as substring match for snapshots names.
@return ListSnapshotResponse
*/

type SnapshotsApiRetrieveSnapshotListOpts struct {
    XTraceId optional.String
    Page optional.Int64
    Size optional.Int64
...
func (a *SnapshotsApiService) RetrieveSnapshotList(ctx context.Context, xRequestId string, instanceId int64, localVarOptionals *SnapshotsApiRetrieveSnapshotListOpts) (ListSnapshotResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SnapshotsApiService Rollback the instance to a specific snapshot by id
 ...
 * @param instanceId The identifier of the instance
 * @param snapshotId The identifier of the snapshot
 * @param optional nil or *SnapshotsApiRollbackSnapshotOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return RollbackSnapshotResponse
*/

type SnapshotsApiRollbackSnapshotOpts struct {
    XTraceId optional.String
}

func (a *SnapshotsApiService) RollbackSnapshot(ctx context.Context, xRequestId string, instanceId int64, snapshotId string, localVarOptionals *SnapshotsApiRollbackSnapshotOpts) (RollbackSnapshotResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/compute/instances/{instanceId}/snapshots/{snapshotId}/rollback"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", fmt.Sprintf("%v", instanceId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"snapshotId"+"}", fmt.Sprintf("%v", snapshotId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RollbackSnapshotResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
SnapshotsApiService Update specific snapshot by id
...
func (a *SnapshotsApiService) UpdateSnapshot(ctx context.Context, body UpdateSnapshotRequest, xRequestId string, instanceId int64, snapshotId string, localVarOptionals *SnapshotsApiUpdateSnapshotOpts) (UpdateSnapshotResponse, *http.Response, error) {
	var (
