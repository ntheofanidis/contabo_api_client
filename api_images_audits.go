...
/*
ImagesAuditsApiService List history about your custom images (audit)
 ...
 * @param optional nil or *ImagesAuditsApiRetrieveImageAuditsListOpts - Optional Parameters:
     ...
     * @param "ImageId" (optional.String) -  The identifier of the image.
...
type ImagesAuditsApiRetrieveImageAuditsListOpts struct {
...
func (a *ImagesAuditsApiService) RetrieveImageAuditsList(ctx context.Context, xRequestId string, localVarOptionals *ImagesAuditsApiRetrieveImageAuditsListOpts) (ImageAuditResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/compute/images/audits"
	...
	if localVarOptionals != nil && localVarOptionals.ImageId.IsSet() {
		localVarQueryParams.Add("imageId", parameterToString(localVarOptionals.ImageId.Value(), ""))
	}
