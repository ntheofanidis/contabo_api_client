...
/*
TagsAuditsApiService List history about your tags (audit)
 ...
 * @param optional nil or *TagsAuditsApiRetrieveTagAuditsListOpts - Optional Parameters:
...
type TagsAuditsApiRetrieveTagAuditsListOpts struct {
...
func (a *TagsAuditsApiService) RetrieveTagAuditsList(ctx context.Context, xRequestId string, localVarOptionals *TagsAuditsApiRetrieveTagAuditsListOpts) (ListTagAuditsResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/tags/audits"
