...
/*
SecretsAuditsApiService List history about your secrets (audit)
 ...
 * @param optional nil or *SecretsAuditsApiRetrieveSecretAuditsListOpts - Optional Parameters:
     ...
     * @param "SecretId" (optional.Int64) -  The id of the secret.
...
type SecretsAuditsApiRetrieveSecretAuditsListOpts struct {
    XTraceId optional.String
    Page optional.Int64
    Size optional.Int64
    OrderBy optional.Interface
    SecretId optional.Int64
    RequestId optional.String
    ChangedBy optional.String
}

func (a *SecretsAuditsApiService) RetrieveSecretAuditsList(ctx context.Context, xRequestId string, localVarOptionals *SecretsAuditsApiRetrieveSecretAuditsListOpts) (ListSecretAuditResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/secrets/audits"
