...
/*
SnapshotsAuditsApiService List history about your snapshots (audit) triggered via the API
 ...
 * @param optional nil or *SnapshotsAuditsApiRetrieveSnapshotsAuditsListOpts - Optional Parameters:
     ...
     * @param "SnapshotId" (optional.String) -  The identifier of the snapshot
...
type SnapshotsAuditsApiRetrieveSnapshotsAuditsListOpts struct {
...
func (a *SnapshotsAuditsApiService) RetrieveSnapshotsAuditsList(ctx context.Context, xRequestId string, localVarOptionals *SnapshotsAuditsApiRetrieveSnapshotsAuditsListOpts) (ListSnapshotsAuditResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/compute/snapshots/audits"
	...
	if localVarOptionals != nil && localVarOptionals.SnapshotId.IsSet() {
		localVarQueryParams.Add("snapshotId", parameterToString(localVarOptionals.SnapshotId.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListSnapshotsAuditResponse
