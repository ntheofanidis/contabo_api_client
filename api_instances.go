...
/*
InstancesApiService Cancel specific instance by id
 ...
 * @param optional nil or *InstancesApiCancelInstanceOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return CancelInstanceResponse
*/

type InstancesApiCancelInstanceOpts struct {
    XTraceId optional.String
}

func (a *InstancesApiService) CancelInstance(ctx context.Context, xRequestId string, instanceId int64, localVarOptionals *InstancesApiCancelInstanceOpts) (CancelInstanceResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/compute/instances/{instanceId}/cancel"
...
/*
InstancesApiService Create a new instance
Create a new instance for your account with the provided parameters.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *InstancesApiCreateInstanceOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return CreateInstanceResponse
*/

type InstancesApiCreateInstanceOpts struct {
    XTraceId optional.String
}

func (a *InstancesApiService) CreateInstance(ctx context.Context, body CreateInstanceRequest, xRequestId string, localVarOptionals *InstancesApiCreateInstanceOpts) (CreateInstanceResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/compute/instances"
...
/*
InstancesApiService Reinstall specific instance
You can reinstall a specific instance with a new image and optionally add ssh keys, a root password or cloud-init.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param instanceId The identifier of the instance
 * @param optional nil or *InstancesApiReinstallInstanceOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return ReinstallInstanceResponse
*/

type InstancesApiReinstallInstanceOpts struct {
    XTraceId optional.String
}

func (a *InstancesApiService) ReinstallInstance(ctx context.Context, body ReinstallInstanceRequest, xRequestId string, instanceId int64, localVarOptionals *InstancesApiReinstallInstanceOpts) (ReinstallInstanceResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/compute/instances/{instanceId}"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", fmt.Sprintf("%v", instanceId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ReinstallInstanceResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
InstancesApiService Get specific instance by id
Get attributes values to a specific instance on your account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param instanceId The identifier of the instance
 * @param optional nil or *InstancesApiRetrieveInstanceOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return FindInstanceResponse
*/

type InstancesApiRetrieveInstanceOpts struct {
    XTraceId optional.String
}

func (a *InstancesApiService) RetrieveInstance(ctx context.Context, xRequestId string, instanceId int64, localVarOptionals *InstancesApiRetrieveInstanceOpts) (FindInstanceResponse, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *InstancesApiRetrieveInstancesListOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     ...
     * @param "Name" (optional.String) -  The name of the instance
     * @param "Region" (optional.String) -  The Region of the instance
     * @param "InstanceId" (optional.Int64) -  The identifier of the instance
     * @param "Status" (optional.String) -  The status of the instance
@return ListInstancesResponse
*/

type InstancesApiRetrieveInstancesListOpts struct {
    XTraceId optional.String
    Page optional.Int64
    Size optional.Int64
...
func (a *InstancesApiService) RetrieveInstancesList(ctx context.Context, xRequestId string, localVarOptionals *InstancesApiRetrieveInstancesListOpts) (ListInstancesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
