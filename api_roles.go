...
/*
RolesApiService Create a new role
 ...
 * @param roleType Role type can be either &#x60;resourcePermission&#x60; for accessing specific resources or &#x60;apiPermission&#x60; for accessing specific API endpoints.
 * @param optional nil or *RolesApiCreateRoleOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return CreateRoleResponse
*/

type RolesApiCreateRoleOpts struct {
    XTraceId optional.String
}

func (a *RolesApiService) CreateRole(ctx context.Context, body CreateRoleRequest, xRequestId string, roleType string, localVarOptionals *RolesApiCreateRoleOpts) (CreateRoleResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/roles/{roleType}"
	localVarPath = strings.Replace(localVarPath, "{"+"roleType"+"}", fmt.Sprintf("%v", roleType), -1)
...
/*
RolesApiService Delete existing role by id
...
func (a *RolesApiService) DeleteRole(ctx context.Context, xRequestId string, roleType string, roleId int64, localVarOptionals *RolesApiDeleteRoleOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/roles/{roleType}/{roleId}"
	localVarPath = strings.Replace(localVarPath, "{"+"roleType"+"}", fmt.Sprintf("%v", roleType), -1)
...
/*
RolesApiService List of API permissions
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *RolesApiRetrieveApiPermissionsListOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     ...
     * @param "ApiName" (optional.String) -  The name of api
@return ListApiPermissionResponse
*/

type RolesApiRetrieveApiPermissionsListOpts struct {
    XTraceId optional.String
    Page optional.Int64
    Size optional.Int64
...
func (a *RolesApiService) RetrieveApiPermissionsList(ctx context.Context, xRequestId string, localVarOptionals *RolesApiRetrieveApiPermissionsListOpts) (ListApiPermissionResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/roles/api-permissions"
	...
	if localVarOptionals != nil && localVarOptionals.ApiName.IsSet() {
		localVarQueryParams.Add("apiName", parameterToString(localVarOptionals.ApiName.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListApiPermissionResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
RolesApiService Get specific role by id
Get attributes of specific role.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param roleType Role type can be either &#x60;resourcePermission&#x60; for accessing specific resources or &#x60;apiPermission&#x60; for accessing specific API endpoints.
 * @param roleId The identifier of the role
 * @param optional nil or *RolesApiRetrieveRoleOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return FindRoleResponse
*/

type RolesApiRetrieveRoleOpts struct {
    XTraceId optional.String
}

func (a *RolesApiService) RetrieveRole(ctx context.Context, xRequestId string, roleType string, roleId int64, localVarOptionals *RolesApiRetrieveRoleOpts) (FindRoleResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param roleType Role type can be either &#x60;resourcePermission&#x60; for accessing specific resources or &#x60;apiPermission&#x60; for accessing specific API endpoints.
 * @param optional nil or *RolesApiRetrieveRoleListOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     * @param "Page" (optional.Int64) -  Number of page to be fetched.
     * @param "Size" (optional.Int64) -  Number of elements per page.
     * @param "OrderBy" (optional.Interface of []string) -  Specify fields and ordering (ASC for ascending, DESC for descending) in following format &#x60;field:ASC|DESC&#x60;.
     * @param "Name" (optional.String) -  The name of the role
     * @param "ApiName" (optional.String) -  The name of api
     * @param "TagName" (optional.String) -  The name of the tag
@return ListRoleResponse
*/

type RolesApiRetrieveRoleListOpts struct {
    XTraceId optional.String
    Page optional.Int64
    Size optional.Int64
    OrderBy optional.Interface
...
func (a *RolesApiService) RetrieveRoleList(ctx context.Context, xRequestId string, roleType string, localVarOptionals *RolesApiRetrieveRoleListOpts) (ListRoleResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.TagName.IsSet() {
		localVarQueryParams.Add("tagName", parameterToString(localVarOptionals.TagName.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
RolesApiService Update specific role by id
 ...
 * @param roleType Role type can be either &#x60;resourcePermission&#x60; for accessing specific resources or &#x60;apiPermission&#x60; for accessing specific API endpoints.
 * @param roleId The identifier of the role
 * @param optional nil or *RolesApiUpdateRoleOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return UpdateRoleResponse
*/

type RolesApiUpdateRoleOpts struct {
    XTraceId optional.String
}

func (a *RolesApiService) UpdateRole(ctx context.Context, body UpdateRoleRequest, xRequestId string, roleType string, roleId int64, localVarOptionals *RolesApiUpdateRoleOpts) (UpdateRoleResponse, *http.Response, error) {
	var (
