...
/*
InstanceActionsApiService Restart a compute instance / resource identified by its id
 ...
 * @param optional nil or *InstanceActionsApiRestartOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return InstanceRestartActionResponse
*/

type InstanceActionsApiRestartOpts struct {
    XTraceId optional.String
}

func (a *InstanceActionsApiService) Restart(ctx context.Context, xRequestId string, instanceId int64, localVarOptionals *InstanceActionsApiRestartOpts) (InstanceRestartActionResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/compute/instances/{instanceId}/actions/restart"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 201 {
			var v InstanceRestartActionResponse
...
/*
InstanceActionsApiService Start a compute instance / resource identified by its id
 ...
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param instanceId The identifier of the compute instance / resource to be started.
 * @param optional nil or *InstanceActionsApiStartOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return InstanceStartActionResponse
*/

type InstanceActionsApiStartOpts struct {
    XTraceId optional.String
}

func (a *InstanceActionsApiService) Start(ctx context.Context, xRequestId string, instanceId int64, localVarOptionals *InstanceActionsApiStartOpts) (InstanceStartActionResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/compute/instances/{instanceId}/actions/start"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", fmt.Sprintf("%v", instanceId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 201 {
			var v InstanceStartActionResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
InstanceActionsApiService Stop compute instance / resource by its id
 ...
 * @param optional nil or *InstanceActionsApiStopOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return InstanceStopActionResponse
*/

type InstanceActionsApiStopOpts struct {
    XTraceId optional.String
}

func (a *InstanceActionsApiService) Stop(ctx context.Context, xRequestId string, instanceId int64, localVarOptionals *InstanceActionsApiStopOpts) (InstanceStopActionResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/compute/instances/{instanceId}/actions/stop"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", fmt.Sprintf("%v", instanceId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 201 {
			var v InstanceStopActionResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
