...
/*
TagAssignmentsAuditsApiService List history about your assignments (audit)
 ...
 * @param optional nil or *TagAssignmentsAuditsApiRetrieveAssignmentsAuditsListOpts - Optional Parameters:
     ...
     * @param "TagId" (optional.Int64) -  The identifier of the tag.
     * @param "ResourceId" (optional.String) -  The identifier of the resource.
     * @param "RequestId" (optional.String) -  The requestId of the API call which led to the change.
     * @param "ChangedBy" (optional.String) -  UserId of the user which led to the change.
@return ListAssignmentAuditsResponse
*/

type TagAssignmentsAuditsApiRetrieveAssignmentsAuditsListOpts struct {
...
func (a *TagAssignmentsAuditsApiService) RetrieveAssignmentsAuditsList(ctx context.Context, xRequestId string, localVarOptionals *TagAssignmentsAuditsApiRetrieveAssignmentsAuditsListOpts) (ListAssignmentAuditsResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/tags/assignments/audits"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListAssignmentAuditsResponse
