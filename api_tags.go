 ...
 * @param optional nil or *TagsApiCreateTagOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return CreateTagResponse
*/

type TagsApiCreateTagOpts struct {
    XTraceId optional.String
}

func (a *TagsApiService) CreateTag(ctx context.Context, body CreateTagRequest, xRequestId string, localVarOptionals *TagsApiCreateTagOpts) (CreateTagResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/tags"
...
/*
TagsApiService Delete existing tag by id
 ...
 * @param optional nil or *TagsApiDeleteTagOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
...
func (a *TagsApiService) DeleteTag(ctx context.Context, xRequestId string, tagId int64, localVarOptionals *TagsApiDeleteTagOpts) (*http.Response, error) {
	var (
...
/*
TagsApiService Get specific tag by id
Get attributes values to a specific tag on your account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param tagId The identifier of the tag
 * @param optional nil or *TagsApiRetrieveTagOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return FindTagResponse
*/

type TagsApiRetrieveTagOpts struct {
    XTraceId optional.String
}

func (a *TagsApiService) RetrieveTag(ctx context.Context, xRequestId string, tagId int64, localVarOptionals *TagsApiRetrieveTagOpts) (FindTagResponse, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *TagsApiRetrieveTagListOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     ...
     * @param "Name" (optional.String) -  Filter as substring match for tag names. Tags may contain letters, numbers, colons, dashes, and underscores. There is a limit of 255 characters per tag.
@return ListTagResponse
*/

type TagsApiRetrieveTagListOpts struct {
    XTraceId optional.String
    Page optional.Int64
    Size optional.Int64
...
func (a *TagsApiService) RetrieveTagList(ctx context.Context, xRequestId string, localVarOptionals *TagsApiRetrieveTagListOpts) (ListTagResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *TagsApiService) UpdateTag(ctx context.Context, body UpdateTagRequest, xRequestId string, tagId int64, localVarOptionals *TagsApiUpdateTagOpts) (UpdateTagResponse, *http.Response, error) {
	var (
