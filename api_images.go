...
/*
ImagesApiService Provide a custom image
 ...
 * @param optional nil or *ImagesApiCreateCustomImageOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return CreateCustomImageResponse
*/

type ImagesApiCreateCustomImageOpts struct {
    XTraceId optional.String
}

func (a *ImagesApiService) CreateCustomImage(ctx context.Context, body CreateCustomImageRequest, xRequestId string, localVarOptionals *ImagesApiCreateCustomImageOpts) (CreateCustomImageResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/compute/images"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 201 {
			var v CreateCustomImageResponse
...
/*
ImagesApiService Delete an uploaded custom image by its id
Your are free to delete a previously uploaded custom images at any time.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param imageId The identifier of the image
 * @param optional nil or *ImagesApiDeleteImageOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.

*/

type ImagesApiDeleteImageOpts struct {
    XTraceId optional.String
}

func (a *ImagesApiService) DeleteImage(ctx context.Context, xRequestId string, imageId string, localVarOptionals *ImagesApiDeleteImageOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/compute/images/{imageId}"
...
/*
ImagesApiService List statistics regarding the customer&#x27;s custom images
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *ImagesApiRetrieveCustomImagesStatsOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return CustomImagesStatsResponse
*/

type ImagesApiRetrieveCustomImagesStatsOpts struct {
    XTraceId optional.String
}

func (a *ImagesApiService) RetrieveCustomImagesStats(ctx context.Context, xRequestId string, localVarOptionals *ImagesApiRetrieveCustomImagesStatsOpts) (CustomImagesStatsResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/compute/images/stats"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CustomImagesStatsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ImagesApiService Get details about a specific image by its id
 ...
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param imageId The identifier of the image
 * @param optional nil or *ImagesApiRetrieveImageOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return FindImageResponse
*/

type ImagesApiRetrieveImageOpts struct {
    XTraceId optional.String
}

func (a *ImagesApiService) RetrieveImage(ctx context.Context, xRequestId string, imageId string, localVarOptionals *ImagesApiRetrieveImageOpts) (FindImageResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ImagesApiService List available standard and custom images
List and filter all available standard images provided by [Contabo](https://contabo.com) and your uploaded custom images.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param optional nil or *ImagesApiRetrieveImageListOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
     ...
     * @param "Name" (optional.String) -  The name of the image
     * @param "StandardImage" (optional.Bool) -  Flag indicating that image is either a standard (true) or a custom image (false)
@return ListImageResponse
*/

type ImagesApiRetrieveImageListOpts struct {
    XTraceId optional.String
    Page optional.Int64
    Size optional.Int64
    OrderBy optional.Interface
    Name optional.String
    StandardImage optional.Bool
}

func (a *ImagesApiService) RetrieveImageList(ctx context.Context, xRequestId string, localVarOptionals *ImagesApiRetrieveImageListOpts) (ListImageResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.StandardImage.IsSet() {
		localVarQueryParams.Add("standardImage", parameterToString(localVarOptionals.StandardImage.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
ImagesApiService Update custom image name by its id
Update name of the custom image.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
 * @param imageId The identifier of the image
 * @param optional nil or *ImagesApiUpdateImageOpts - Optional Parameters:
     * @param "XTraceId" (optional.String) -  Identifier to trace group of requests.
@return UpdateCustomImageResponse
*/

type ImagesApiUpdateImageOpts struct {
    XTraceId optional.String
}

func (a *ImagesApiService) UpdateImage(ctx context.Context, body UpdateCustomImageRequest, xRequestId string, imageId string, localVarOptionals *ImagesApiUpdateImageOpts) (UpdateCustomImageResponse, *http.Response, error) {
	var (
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v UpdateCustomImageResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
